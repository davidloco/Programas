...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab2-tab2-module"], {
  ...
  function srcAppPagesTab2Tab2PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Tab2Page = /*#__PURE__*/function () {
      function Tab2Page(programasServices) {
      ...
      _createClass(Tab2Page, [{
        ...
        value: function ngOnInit() {
          ...
          this.programasServices.getProgramas().subscribe(function (resp) {
            var _this$programas;

            (_this$programas = _this.programas).push.apply(_this$programas, _toConsumableArray(resp.programa));
          });
        }
      }, {
        key: "buscarPrograma",
        value: function buscarPrograma(event) {
          this.textoBuscar = event.target.value;
        }
      }, {
        key: "updateList",
        value: function updateList(ev) {
          var _this2 = this;

          this.programasServices.getProgramasFind(ev.target.value).subscribe(function (resp) {
            var _this2$programas;

            (_this2$programas = _this2.programas).push.apply(_this2$programas, _toConsumableArray(resp.programa));
          });
        }
      }]);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_programas_service__WEBPACK_IMPORTED_MODULE_2__["ProgramasService"]])], Tab2Page);
    /***/
  }
}]);
