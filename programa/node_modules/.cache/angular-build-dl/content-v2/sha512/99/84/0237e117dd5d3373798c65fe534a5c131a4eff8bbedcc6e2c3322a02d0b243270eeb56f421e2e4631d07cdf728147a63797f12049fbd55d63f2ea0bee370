...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab3-tab3-module"], {
  ...
  function srcAppPagesTab3Tab3PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Tab3Page = function Tab3Page(datalocalService) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_services_data_local_service__WEBPACK_IMPORTED_MODULE_2__["DataLocalService"]])], Tab3Page);
    /***/
  }
}]);
